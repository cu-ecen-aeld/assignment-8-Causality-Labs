...
MODULES_MODULE_SYMVERS_LOCATION:append = "scull"
...
do_install:append() {
    ...
    install -d ${D}${bindir} 
	install -m 0755 ${WORKDIR}/scull_load.sh ${D}${bindir}/scull_load
    install -m 0755 ${WORKDIR}/scull_unload.sh ${D}${bindir}/scull_unload

    install -d ${D}${sysconfdir}/init.d
    install -m 0755 ${WORKDIR}/init.sh ${D}${sysconfdir}/init.d/scull-start-stop
}